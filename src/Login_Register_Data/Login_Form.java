...
public class Login_Form extends javax.swing.JFrame {
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        if (username.isEmpty() || password.isEmpty()) {
            ...
            try {
                String query = "select * from administrador where nombre_admin = ?";
                ps = conexion.prepareStatement(query);
                ps.setString(1, username);
                res = ps.executeQuery();
                if (res.next()) {
                    System.out.println(res.getString(8));
                    if (password.equals(res.getString(8))) {
                    ...
                    JOptionPane.showMessageDialog(null, "Error con algun campo, intente nuevamente.");
                }
